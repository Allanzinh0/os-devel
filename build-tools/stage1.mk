...
STAGE1_ASMFLAGS := ${TARGET_ASMFLAGS} -f elf -DFILESYSTEM=${MAKE_PART_FORMAT} -I${STAGE1_SRC}
STAGE1_LINKFLAGS := ${TARGET_LINKFLAGS} -Wl,-T ${STAGE1_SRC}/linker.ld -nostdlib

STAGE1_SRC_ASM=$(shell find $(STAGE1_SRC) -type f -name  "*.asm")
STAGE1_HEADERS_ASM=$(shell find $(STAGE1_SRC) -type f -name  "*.inc")
...
$(OBJ_DIR)/stage1/asm/%.obj: $(STAGE1_SRC)/%.asm $(STAGE1_HEADERS_ASM)
	@mkdir -p $(@D)
