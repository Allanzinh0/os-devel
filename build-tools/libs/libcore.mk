...
LIBCORE_CFLAGS := ${TARGET_CFLAGS} -ffreestanding
LIBCORE_CXXFLAGS := ${TARGET_CXXFLAGS} -ffreestanding -I$(LIBCORE_SRC)
...
$(BUILD_DIR)/libs/libcore.o: $(LIBCORE_OBJ_ASM) $(LIBCORE_OBJ_C) $(LIBCORE_OBJ_CXX)
	@mkdir -p $(@D)
